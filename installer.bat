...
del "%localappdata%\Temp\qwix.minecity\detect_fin.mci" /F /S /Q
del "%localappdata%\Temp\qwix.minecity\detect_fin.mci" /F /S /Q
del "%localappdata%\Temp\qwix.minecity\update.mci" /F /S /Q
del "%localappdata%\Temp\qwix.minecity\minecity_api.mci" /F /S /Q
rmdir "%localappdata%\Temp\qwix.minecity\Minecity API"
del .\updater.bat
exit
